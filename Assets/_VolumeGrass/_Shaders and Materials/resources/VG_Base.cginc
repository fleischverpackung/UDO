...
//	#endif
	...
	o.Alpha=(rayPos.z>-0.001) ? floor_cw : o.Alpha;
		...
		//
		//sceneDepth = LinearEyeDepth(tex2Dproj(_GrassDepthTex, UNITY_PROJ_COORD(IN.screenPos)).r);
		#if defined(UNITY_REVERSED_Z)
			sceneDepth = 1.0 / ((_VGZBufferParamA * (1 - tex2Dproj(_GrassDepthTex, UNITY_PROJ_COORD(IN.screenPos)).r)) + _VGZBufferParamB);
		#else
