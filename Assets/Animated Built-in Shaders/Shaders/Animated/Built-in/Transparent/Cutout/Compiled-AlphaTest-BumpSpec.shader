Shader "Animated/Built-in/Transparent/Cutout/Bumped Specular" {
Properties {
...
void main ()
{
  ...
  tmpvar_13 = max (0.0, dot (tmpvar_7, xlv_TEXCOORD1));
  mediump float tmpvar_14;
  tmpvar_14 = max (0.0, dot (tmpvar_7, normalize((xlv_TEXCOORD1 + viewDir_10))));
  nh_12 = tmpvar_14;
  ...
  tmpvar_17 = ((((tmpvar_4 * _LightColor0.xyz) * tmpvar_13) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_16)) * 2.0);
  c_11.xyz = tmpvar_17;
  highp float tmpvar_18;
  tmpvar_18 = (tmpvar_5 + ((_LightColor0.w * _SpecColor.w) * tmpvar_16));
  c_11.w = tmpvar_18;
  c_1.xyz = (c_11.xyz + (tmpvar_4 * xlv_TEXCOORD2));
  c_1.w = tmpvar_5;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  highp float nh_12;
  lowp float tmpvar_13;
  tmpvar_13 = max (0.0, dot (normal_7, xlv_TEXCOORD1));
  mediump float tmpvar_14;
  tmpvar_14 = max (0.0, dot (normal_7, normalize((xlv_TEXCOORD1 + viewDir_10))));
  nh_12 = tmpvar_14;
  mediump float arg1_15;
  arg1_15 = (_Shininess * 128.0);
  highp float tmpvar_16;
...
void main ()
{
  ...
  c_1.xyz = ((tmpvar_3.xyz * _Color.xyz) * ((8.0 * tmpvar_8.w) * tmpvar_8.xyz));
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_23 = max (0.0, dot (tmpvar_7, normalize((normalize((((scalePerBasisVector_16.x * v_20) + (scalePerBasisVector_16.y * v_21)) + (scalePerBasisVector_16.z * v_22))) + viewDir_11))));
  nh_13 = tmpvar_23;
  highp float tmpvar_24;
...
void main ()
{
  ...
  tmpvar_30 = (c_1.xyz + (tmpvar_4 * tmpvar_12.xyz));
  c_1.xyz = tmpvar_30;
  c_1.w = tmpvar_5;
  gl_FragData[0] = c_1;
}
...
// FLOW 1 static, 0 dynamic
"vs_4_0
eefiecedoknjdlmjhpkpgdekekgmjhkbidfjbgclabaaaaaaiaaiaaaaadaaaaaa
...
void main ()
{
  ...
  tmpvar_19 = max (0.0, dot (tmpvar_7, xlv_TEXCOORD1));
  mediump float tmpvar_20;
  tmpvar_20 = max (0.0, dot (tmpvar_7, normalize((xlv_TEXCOORD1 + viewDir_16))));
  nh_18 = tmpvar_20;
  mediump float arg1_21;
  arg1_21 = (_Shininess * 128.0);
  highp float tmpvar_22;
  tmpvar_22 = (pow (nh_18, arg1_21) * tmpvar_3.w);
  highp vec3 tmpvar_23;
  tmpvar_23 = ((((tmpvar_4 * _LightColor0.xyz) * tmpvar_19) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_22)) * (tmpvar_9 * 2.0));
  c_17.xyz = tmpvar_23;
  highp float tmpvar_24;
  tmpvar_24 = (tmpvar_5 + (((_LightColor0.w * _SpecColor.w) * tmpvar_22) * tmpvar_9));
  c_17.w = tmpvar_24;
  c_1.xyz = (c_17.xyz + (tmpvar_4 * xlv_TEXCOORD2));
  c_1.w = tmpvar_5;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_14 = max (0.0, dot (normal_7, xlv_TEXCOORD1));
  mediump float tmpvar_15;
  tmpvar_15 = max (0.0, dot (normal_7, normalize((xlv_TEXCOORD1 + viewDir_11))));
  nh_13 = tmpvar_15;
  ...
  tmpvar_18 = ((((tmpvar_4 * _LightColor0.xyz) * tmpvar_14) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_17)) * (tmpvar_9.x * 2.0));
  c_12.xyz = tmpvar_18;
  highp float tmpvar_19;
  tmpvar_19 = (tmpvar_5 + (((_LightColor0.w * _SpecColor.w) * tmpvar_17) * tmpvar_9.x));
  c_12.w = tmpvar_19;
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
eeacaaaaeaaaabaajbaaaaaafjaaaaaeegiocaaaaaaaaaaaaoaaaaaafjaaaaae
...
dcaaaaaldccabaaaacaaaaaaegbabaaaaeaaaaaaegiacaaaaaaaaaaaalaaaaaa
ogikcaaaaaaaaaaaalaaaaaadiaaaaaiccaabaaaaaaaaaaabkaabaaaaaaaaaaa
...
void main ()
{
  ...
  tmpvar_6 = tmpvar_11;
  c_1.xyz = ((tmpvar_3.xyz * _Color.xyz) * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((tmpvar_6 * 2.0))));
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_1.xyz = ((tmpvar_3.xyz * _Color.xyz) * max (min (tmpvar_10, ((tmpvar_8.x * 2.0) * tmpvar_9.xyz)), (tmpvar_10 * tmpvar_8.x)));
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
}
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
adaaaaaaagiecaaaaaaaaaaaanaaaaaakgiocaaaaaaaaaaaanaaaaaadcaaaaal
dccabaaaacaaaaaaegbabaaaaeaaaaaaegiacaaaaaaaaaaaalaaaaaaogikcaaa
...
void main ()
{
  ...
  tmpvar_29 = max (0.0, dot (tmpvar_7, normalize((normalize((((scalePerBasisVector_22.x * v_26) + (scalePerBasisVector_22.y * v_27)) + (scalePerBasisVector_22.z * v_28))) + viewDir_17))));
  nh_19 = tmpvar_29;
  ...
  tmpvar_32 = (((lm_23 * _SpecColor.xyz) * tmpvar_3.w) * tmpvar_30);
  ...
  tmpvar_35 = (c_1.xyz + (tmpvar_4 * min (tmpvar_16.xyz, tmpvar_34)));
  c_1.xyz = tmpvar_35;
  c_1.w = tmpvar_5;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec4 tmpvar_11;
  tmpvar_11 = texture2D (unity_LightmapInd, xlv_TEXCOORD1);
  highp vec3 tmpvar_12;
  ...
  tmpvar_26 = max (0.0, dot (normal_7, normalize((normalize((((scalePerBasisVector_19.x * v_23) + (scalePerBasisVector_19.y * v_24)) + (scalePerBasisVector_19.z * v_25))) + viewDir_14))));
  nh_16 = tmpvar_26;
  highp float tmpvar_27;
  ...
  highp vec3 tmpvar_29;
  tmpvar_29 = (((lm_20 * _SpecColor.xyz) * tmpvar_3.w) * tmpvar_27);
  ...
  lowp vec3 arg1_31;
  arg1_31 = ((tmpvar_9.x * 2.0) * tmpvar_10.xyz);
  mediump vec3 tmpvar_32;
  tmpvar_32 = (c_1.xyz + (tmpvar_4 * max (min (tmpvar_13.xyz, arg1_31), (tmpvar_13.xyz * tmpvar_9.x))));
  c_1.xyz = tmpvar_32;
  c_1.w = tmpvar_5;
  gl_FragData[0] = c_1;
}
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
void main ()
{
  ...
  tmpvar_16 = max (0.0, dot (tmpvar_7, xlv_TEXCOORD1));
  mediump float tmpvar_17;
  tmpvar_17 = max (0.0, dot (tmpvar_7, normalize((xlv_TEXCOORD1 + viewDir_13))));
  nh_15 = tmpvar_17;
  ...
  tmpvar_20 = ((((tmpvar_4 * _LightColor0.xyz) * tmpvar_16) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_19)) * (shadow_9 * 2.0));
  c_14.xyz = tmpvar_20;
  highp float tmpvar_21;
  tmpvar_21 = (tmpvar_5 + (((_LightColor0.w * _SpecColor.w) * tmpvar_19) * shadow_9));
  c_14.w = tmpvar_21;
  c_1.xyz = (c_14.xyz + (tmpvar_4 * xlv_TEXCOORD2));
  c_1.w = tmpvar_5;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  shadow_6 = tmpvar_8;
  c_1.xyz = ((tmpvar_3.xyz * _Color.xyz) * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((shadow_6 * 2.0))));
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  v_25.z = tmpvar_17[2].z;
  mediump float tmpvar_26;
  tmpvar_26 = max (0.0, dot (tmpvar_7, normalize((normalize((((scalePerBasisVector_19.x * v_23) + (scalePerBasisVector_19.y * v_24)) + (scalePerBasisVector_19.z * v_25))) + viewDir_14))));
  nh_16 = tmpvar_26;
  highp float tmpvar_27;
  mediump float arg1_28;
  arg1_28 = (_Shininess * 128.0);
  ...
  mediump vec3 tmpvar_32;
  tmpvar_32 = (c_1.xyz + (tmpvar_4 * min (tmpvar_13.xyz, tmpvar_31)));
  c_1.xyz = tmpvar_32;
  c_1.w = tmpvar_5;
  gl_FragData[0] = c_1;
}
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 27 to 78, TEX: 2 to 5
//   d3d9 - ALU: 37 to 90, TEX: 3 to 6
//   d3d11 - ALU: 16 to 56, TEX: 2 to 5, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_Time]
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedicnbpejjffchnalpcmkdedpklmjflhdhabaaaaaaciahaaaaadaaaaaa
...
fdeieefccaagaaaaeaaaaaaaiiabaaaafjaaaaaeegiocaaaaaaaaaaaakaaaaaa
...

...

...
agaabaaaabaaaaaajgahbaaaabaaaaaaaaaaaaahhcaabaaaabaaaaaaegacbaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedkejdoafkcpkgokafclehmijkpfoijlbmabaaaaaaceaeaaaaadaaaaaa
...

...
def c9, 2.00000000, -1.00000000, 8.00000000, 128.00000000
...
rcp_pp r3.z, r1.w
dp3_pp r1.x, r3, r1
max_pp r2.z, r1.x, c7.w
mul_pp r0.w, c9, r0
pow r1, r2.z, r0.w
mov r0.w, r1.x
dp3_pp_sat r1.z, r3, c10
dp3_pp_sat r1.y, r3, c11
dp3_pp_sat r1.x, r3, c12
dp3_pp r0.x, r1, r0
texld r3, v1, s2
...
texld r2, r0, s0
mul_pp r1.w, r2, c4
mul_pp r0.xyz, r1, c9.z
mul_pp r1.xyz, r0, c1
mul_pp r1.xyz, r2.w, r1
add_pp r3.x, r1.w, -c6
cmp r2.w, r3.x, c7, c7.y
mov_pp r3, -r2.w
mul r1.xyz, r1, r0.w
mul_pp r2.xyz, r2, c4
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedoidiogbjeaibddbjefhlkbhgbcdlmbcaabaaaaaaomaiaaaaadaaaaaa
...
gbhcghgfheaaklklfdeieefcpmahaaaaeaaaaaaappabaaaafjaaaaaeegiocaaa
...
bgibcaiaebaaaaaaaaaaaaaaaeaaaaaadiaaaaahpcaabaaaaaaaaaaaagaabaaa
...
aaaaaaaafganbaiaebaaaaaaaaaaaaaafgifcaaaaaaaaaaaaeaaaaaadcaaaaal
...

...

...

...
hcaabaaaadaaaaaapgapbaaaabaaaaaaegbcbaaaadaaaaaadcaaaaajhcaabaaa
...
akiacaaaaaaaaaaaagaaaaaaabeaaaaaaaaaaaeddiaaaaahicaabaaaaaaaaaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedgjdkhkhecobkkhpahjfmoagepigginnpabaaaaaameahaaaaadaaaaaa
...
eaaaaaaakjabaaaafjaaaaaeegiocaaaaaaaaaaaaoaaaaaafjaaaaaeegiocaaa
...

...

...
aaaaaaahicaabaaaaaaaaaaaakaabaaaacaaaaaaakaabaaaacaaaaaadcaaaaaj
...
def c5, 0.00555556, 1.00000000, 3.14159274, 0.00000000
def c6, 0.15915491, 0.50000000, 6.28318501, -3.14159298
def c7, 8.00000000, 2.00000000, 0, 0
dcl_texcoord0 v0.xy
dcl_texcoord1 v1.xy
dcl_texcoord2 v2
mov r0.x, c2.w
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedngdikbaibncbckoghkejfjpbmllaeipkabaaaaaadaafaaaaadaaaaaa
cmaaaaaaleaaaaaaoiaaaaaaejfdeheoiaaaaaaaaeaaaaaaaiaaaaaagiaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaaheaaaaaaaaaaaaaaaaaaaaaa
...
aaaaaaaaegaabaaaabaaaaaaeghobaaaaaaaaaaaaagabaaaabaaaaaadcaaaaam
bcaabaaaabaaaaaadkaabaaaaaaaaaaadkiacaaaaaaaaaaaajaaaaaaakiacaia
ebaaaaaaaaaaaaaaaoaaaaaadiaaaaaipcaabaaaaaaaaaaaegaobaaaaaaaaaaa
...
acaaaaaaeghobaaaacaaaaaaaagabaaaacaaaaaadiaaaaahocaabaaaabaaaaaa
...
MUL R1.xyz, R3.y, c[9];
MAD R0.xyz, R3.x, c[10], R1;
MOV R1.w, c[0].y;
MUL R0.w, R0, c[7].z;
MAD R0.w, R1, c[3].z, R0;
COS R2.w, R0.w;
SIN R3.w, R0.w;
ADD R1.x, fragment.texcoord[0].w, -c[3].y;
MUL R1.y, R3.w, R1.x;
MAD R0.xyz, R3.z, c[8], R0;
MUL R1.x, R2.w, R1;
ADD R0.w, fragment.texcoord[0].z, -c[3].x;
MAD R1.x, R3.w, R0.w, R1;
MAD R0.w, R2, R0, -R1.y;
ADD R1.x, -R1, c[3].y;
MAD R1.y, R1.w, c[2], R1.x;
ADD R0.w, -R0, c[3].x;
MAD R1.x, R1.w, c[2], R0.w;
TEX R4.yw, R1, texture[1], 2D;
MAD R2.xy, R4.wyzw, c[7].w, -c[7].y;
DP3 R0.w, R0, R0;
RSQ R0.w, R0.w;
MUL R1.xy, R2, R2;
MUL R0.xyz, R0.w, R0;
...
RSQ R1.x, R1.x;
MAD R4.xyz, R1.x, fragment.texcoord[2], R0;
ADD R0.w, -R0, c[7].y;
RSQ R0.x, R0.w;
RCP R2.z, R0.x;
DP3 R0.y, R4, R4;
...
MUL R2.y, R0.w, c[5].x;
MAX R0.w, R2.x, c[9];
ADD R2.x, fragment.texcoord[0].y, -c[3].y;
POW R0.w, R0.w, R2.y;
MUL R2.y, R2.x, R3.w;
MUL R2.z, R2.w, R2.x;
ADD R2.x, fragment.texcoord[0], -c[3];
MAD R2.z, R2.x, R3.w, R2;
MAD R2.x, R2, R2.w, -R2.y;
ADD R2.y, -R2.z, c[3];
ADD R2.x, -R2, c[3];
MUL R1.xyz, R1, c[1];
MAD R2.y, R1.w, c[2], R2;
MAD R2.x, R1.w, c[2], R2;
...
texld r1.yw, r1, s1
mad_pp r2.xy, r1.wyzw, c9.x, c9.y
...
dp3_pp r0.z, r1, r4
mad r1.xyz, r4.x, c12, r3
mad r4.xyz, r4.z, c10, r1
texld r3, v1, s3
mul_pp r1.xyz, r3.w, r3
...
mul r0.w, r0.z, r0.y
mul r0.z, r0, r0.x
mad r0.y, r1.w, r0, r0.z
mad r0.z, r1.w, r0.x, -r0.w
add r0.x, -r0.y, c3.y
mov r0.y, c2
mad r0.y, c0, r0, r0.x
add r0.x, -r0.z, c3
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...

...

...
adaaaaaadcaaaaajhcaabaaaacaaaaaaegacbaaaacaaaaaapgapbaaaaaaaaaaa
egacbaaaadaaaaaabaaaaaahicaabaaaaaaaaaaaegacbaaaacaaaaaaegacbaaa
...
diaaaaaibcaabaaaabaaaaaaakiacaaaaaaaaaaaakaaaaaaabeaaaaaaaaaaaed
diaaaaahicaabaaaaaaaaaaadkaabaaaaaaaaaaaakaabaaaabaaaaaabjaaaaaf
icaabaaaaaaaaaaadkaabaaaaaaaaaaadcaaaaajhccabaaaaaaaaaaaegacbaaa
...
void main ()
{
  ...
  tmpvar_16 = ((((tmpvar_5 * _LightColor0.xyz) * tmpvar_12) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_15)) * 2.0);
  c_10.xyz = tmpvar_16;
  highp float tmpvar_17;
  tmpvar_17 = (tmpvar_6 + ((_LightColor0.w * _SpecColor.w) * tmpvar_15));
  c_10.w = tmpvar_17;
  c_1.xyz = c_10.xyz;
  c_1.w = tmpvar_6;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  highp float nh_15;
  lowp float tmpvar_16;
  tmpvar_16 = max (0.0, dot (tmpvar_8, lightDir_2));
  mediump float tmpvar_17;
  tmpvar_17 = max (0.0, dot (tmpvar_8, normalize((lightDir_2 + normalize(xlv_TEXCOORD2)))));
  nh_15 = tmpvar_17;
  mediump float arg1_18;
  arg1_18 = (_Shininess * 128.0);
  highp float tmpvar_19;
  tmpvar_19 = (pow (nh_15, arg1_18) * tmpvar_4.w);
  highp vec3 tmpvar_20;
  tmpvar_20 = ((((tmpvar_5 * _LightColor0.xyz) * tmpvar_16) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_19)) * (atten_13 * 2.0));
  c_14.xyz = tmpvar_20;
  highp float tmpvar_21;
...
void main ()
{
  ...
  highp float nh_15;
  lowp float tmpvar_16;
  tmpvar_16 = max (0.0, dot (normal_8, lightDir_2));
  mediump float tmpvar_17;
  tmpvar_17 = max (0.0, dot (normal_8, normalize((lightDir_2 + normalize(xlv_TEXCOORD2)))));
  nh_15 = tmpvar_17;
  mediump float arg1_18;
  arg1_18 = (_Shininess * 128.0);
  highp float tmpvar_19;
...
void main ()
{
  ...
  highp float nh_12;
  lowp float tmpvar_13;
  tmpvar_13 = max (0.0, dot (tmpvar_8, lightDir_2));
  mediump float tmpvar_14;
  tmpvar_14 = max (0.0, dot (tmpvar_8, normalize((lightDir_2 + normalize(xlv_TEXCOORD2)))));
  nh_12 = tmpvar_14;
  mediump float arg1_15;
  arg1_15 = (_Shininess * 128.0);
  highp float tmpvar_16;
  ...
  highp vec3 tmpvar_17;
  tmpvar_17 = ((((tmpvar_5 * _LightColor0.xyz) * tmpvar_13) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_16)) * (atten_10 * 2.0));
  c_11.xyz = tmpvar_17;
  highp float tmpvar_18;
...
void main ()
{
  ...
  highp float nh_12;
  lowp float tmpvar_13;
  tmpvar_13 = max (0.0, dot (normal_8, lightDir_2));
  mediump float tmpvar_14;
  tmpvar_14 = max (0.0, dot (normal_8, normalize((lightDir_2 + normalize(xlv_TEXCOORD2)))));
  nh_12 = tmpvar_14;
  mediump float arg1_15;
  arg1_15 = (_Shininess * 128.0);
  highp float tmpvar_16;
...
Program "fp" {
// Fragment combos: 5
//   opengl - ALU: 61 to 72, TEX: 2 to 4
//   d3d9 - ALU: 76 to 85, TEX: 3 to 5
//   d3d11 - ALU: 38 to 48, TEX: 2 to 4, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "POINT" }
Vector 0 [_Time]
Vector 1 [_LightColor0]
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
giaaaaacaeaaaaaadcaaaaakbcaabaaaaaaaaaaadkiacaaaaaaaaaaaaiaaaaaa
...

...

...

...

...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
epfdejfeejepeoaafeeffiedepepfceeaaklklklepfdeheocmaaaaaaabaaaaaa
aiaaaaaacaaaaaaaaaaaaaaaaaaaaaaaadaaaaaaaaaaaaaaapaaaaaafdfgfpfe
gbhcghgfheaaklklfdeieefcpaafaaaaeaaaaaaahmabaaaafjaaaaaeegiocaaa
...

...

...
hcaabaaaaaaaaaaaegacbaaaaaaaaaaaagaabaaaabaaaaaajgahbaaaabaaaaaa
...
MUL R2.y, R2.x, R3.x;
MUL R2.z, R1.w, R2.x;
ADD R2.x, fragment.texcoord[0], -c[4];
MAD R1.w, R2.x, R1, -R2.y;
MAD R2.z, R2.x, R3.x, R2;
ADD R2.x, -R2.z, c[4].y;
MAD R2.y, R2.w, c[3], R2.x;
ADD R1.w, -R1, c[4].x;
MAD R2.x, R2.w, c[3], R1.w;
TEX R2, R2, texture[0], 2D;
MUL R3.x, R2.w, R0.w;
DP3 R0.w, R0, R1;
MUL R0.xyz, R2, c[5];
...
MAD R2.xy, fragment.texcoord[3], R0.w, c[9].z;
...
mul_pp r1.w, r0, c5
rcp r0.x, v3.w
mad r2.xy, v3, r0.x, c9.y
dp3 r0.x, v3, v3
texld r0.w, r2, s2
cmp r0.z, -v3, c8.w, c8.y
mul_pp r0.z, r0, r0.w
texld r0.x, r0.x, s3
mul_pp r0.z, r0, r0.x
add_pp r0.y, r1.w, -c7.x
mul_pp r2.x, r0.z, c10
cmp r0.x, r0.y, c8.w, c8.y
mov_pp r0, -r0.x
mul oC0.xyz, r1, r2.x
texkill r0.xyzw
mov_pp oC0.w, r1
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...

...
pcaabaaaaaaaaaaaigaabaaaabaaaaaaeghobaaaaaaaaaaaaagabaaaacaaaaaa
...
dcaaaaamicaabaaaabaaaaaadkaabaaaaaaaaaaadkiacaaaaaaaaaaaajaaaaaa
akiacaiaebaaaaaaaaaaaaaaanaaaaaadbaaaaahicaabaaaabaaaaaadkaabaaa
abaaaaaaabeaaaaaaaaaaaaaanaaaeaddkaabaaaabaaaaaaapaaaaahicaabaaa
...

...

...

...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
mad r0.xyz, r0, r1.w, r1
texld r1.w, v3, s2
mul_pp r2.x, r1.w, c10
add_pp r1.x, r0.w, -c7
cmp r1.x, r1, c8.w, c8.y
mov_pp r1, -r1.x
mul oC0.xyz, r0, r2.x
texkill r1.xyzw
mov_pp oC0.w, r0
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...

...
// FLOW 1 static, 0 dynamic
"vs_4_0

...

...
void main ()
{
  ...
  lowp float x_6;
  x_6 = ((texture2D (_MainTex, tmpvar_3).w * _Color.w) - _Cutoff);
  if ((x_6 < 0.0)) {
    discard;
  };
  highp float tmpvar_7;
  tmpvar_7 = dot (xlv_TEXCOORD1, tmpvar_5);
  worldN_2.x = tmpvar_7;
  highp float tmpvar_8;
  tmpvar_8 = dot (xlv_TEXCOORD2, tmpvar_5);
  worldN_2.y = tmpvar_8;
  highp float tmpvar_9;
  tmpvar_9 = dot (xlv_TEXCOORD3, tmpvar_5);
  worldN_2.z = tmpvar_9;
...
void main ()
{
  ...
  highp float tmpvar_7;
  tmpvar_7 = dot (xlv_TEXCOORD1, normal_5);
  worldN_2.x = tmpvar_7;
  highp float tmpvar_8;
  tmpvar_8 = dot (xlv_TEXCOORD2, normal_5);
  worldN_2.y = tmpvar_8;
  highp float tmpvar_9;
  tmpvar_9 = dot (xlv_TEXCOORD3, normal_5);
  worldN_2.z = tmpvar_9;
  res_1.xyz = ((worldN_2 * 0.5) + 0.5);
  res_1.w = _Shininess;
  gl_FragData[0] = res_1;
...
Program "fp" {
// Fragment combos: 1
//   opengl - ALU: 43 to 43, TEX: 2 to 2
//   d3d9 - ALU: 55 to 55, TEX: 3 to 3
//   d3d11 - ALU: 22 to 22, TEX: 2 to 2, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { }
Vector 0 [_Time]
Vector 1 [_PanMT]
...
MAD R0.x, R0, R1.y, -R0.y;
ADD R0.y, -R0.z, c[2];
ADD R0.x, -R0, c[2];
MAD R0.x, R1, c[1], R0;
MAD R0.y, R1.x, c[1], R0;
TEX R0.yw, R0, texture[1], 2D;
MAD R0.xy, R0.wyzw, c[6].w, -c[6].y;
MUL R0.zw, R0.xyxy, R0.xyxy;
ADD_SAT R0.z, R0, R0.w;
...
MAD R1.w, R1, R0, R2.y;
MAD R0.w, R1.y, R0, -R2.x;
ADD R1.y, -R1.w, c[2];
MAD R1.y, R1.x, c[1], R1;
ADD R0.w, -R0, c[2].x;
MAD R1.x, R1, c[1], R0.w;
...
texld r0.w, r0, s0
mov_pp r1.w, c5.x
mad_pp r0.x, r0.w, c3.w, -r1.w
cmp r0.w, r0.x, c6, c6.y
dp3 r0.y, r1, v2
dp3 r0.x, r1, v1
mov_pp r1, -r0.w
mad_pp oC0.xyz, r0, c7.y, c7.y
texkill r1.xyzw
mov_pp oC0.w, c4.x
"
}
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
iccabaaaaaaaaaaaakiacaaaaaaaaaaaagaaaaaadoaaaaab"
}
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
ahaiaaaafdfgfpfaepfdejfeejepeoaafeeffiedepepfceeaaklklklfdeieefc
daaeaaaaeaaaabaaamabaaaafjaaaaaeegiocaaaaaaaaaaaajaaaaaafjaaaaae
...
aiaaaaaakgiocaaaaaaaaaaaaiaaaaaadiaaaaaiccaabaaaaaaaaaaabkaabaaa
...
void main ()
{
  ...
  spec_13 = tmpvar_14;
  mediump vec3 tmpvar_15;
  tmpvar_15 = ((tmpvar_6 * light_3.xyz) + ((light_3.xyz * _SpecColor.xyz) * spec_13));
  c_12.xyz = tmpvar_15;
  c_12.w = (tmpvar_7 + (spec_13 * _SpecColor.w));
  c_2 = c_12;
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  tmpvar_7 = (tmpvar_5.w * _Color.w);
  highp vec2 tmpvar_8;
  tmpvar_8.x = ((_RotMT.x - (((xlv_TEXCOORD0.z - _RotMT.x) * cos(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))) - ((xlv_TEXCOORD0.w - _RotMT.y) * sin(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))))) + (_PanMT.x * _Time.y));
  tmpvar_8.y = ((_RotMT.y - (((xlv_TEXCOORD0.z - _RotMT.x) * sin(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))) + ((xlv_TEXCOORD0.w - _RotMT.y) * cos(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))))) + (_PanMT.y * _Time.y));
  lowp vec3 normal_9;
  normal_9.xy = ((texture2D (_BumpMap, tmpvar_8).wy * 2.0) - 1.0);
  ...
  tmpvar_17 = ((tmpvar_6 * light_3.xyz) + ((light_3.xyz * _SpecColor.xyz) * spec_15));
  c_14.xyz = tmpvar_17;
  c_14.w = (tmpvar_7 + (spec_15 * _SpecColor.w));
  c_2 = c_14;
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
Bind "texcoord1" TexCoord1
Bind "color" Color
ConstBuffer "$Globals" 208 // 160 used size, 13 vars
Vector 112 [unity_LightmapST] 4
Vector 128 [_MainTex_ST] 4
Vector 144 [_BumpMap_ST] 4
ConstBuffer "UnityPerCamera" 128 // 96 used size, 8 vars
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
agabaaaafjaaaaaeegiocaaaaaaaaaaaakaaaaaafjaaaaaeegiocaaaabaaaaaa
...
void main ()
{
  ...
  tmpvar_20 = ((tmpvar_9 * light_6.xyz) + ((light_6.xyz * _SpecColor.xyz) * spec_18));
  c_17.xyz = tmpvar_20;
  c_17.w = (tmpvar_10 + (spec_18 * _SpecColor.w));
  c_2 = c_17;
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  tmpvar_10 = (tmpvar_8.w * _Color.w);
  highp vec2 tmpvar_11;
  tmpvar_11.x = ((_RotMT.x - (((xlv_TEXCOORD0.z - _RotMT.x) * cos(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))) - ((xlv_TEXCOORD0.w - _RotMT.y) * sin(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))))) + (_PanMT.x * _Time.y));
  tmpvar_11.y = ((_RotMT.y - (((xlv_TEXCOORD0.z - _RotMT.x) * sin(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))) + ((xlv_TEXCOORD0.w - _RotMT.y) * cos(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))))) + (_PanMT.y * _Time.y));
  lowp vec3 normal_12;
  normal_12.xy = ((texture2D (_BumpMap, tmpvar_11).wy * 2.0) - 1.0);
  ...
  tmpvar_24 = ((tmpvar_9 * light_6.xyz) + ((light_6.xyz * _SpecColor.xyz) * spec_22));
  c_21.xyz = tmpvar_24;
  c_21.w = (tmpvar_10 + (spec_22 * _SpecColor.w));
  c_2 = c_21;
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
void main ()
{
  ...
  tmpvar_8.y = ((_RotMT.y - (((xlv_TEXCOORD0.z - _RotMT.x) * sin(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))) + ((xlv_TEXCOORD0.w - _RotMT.y) * cos(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))))) + (_PanMT.y * _Time.y));
  lowp vec3 tmpvar_9;
  tmpvar_9 = ((texture2D (_BumpMap, tmpvar_8).xyz * 2.0) - 1.0);
  lowp float x_10;
  x_10 = (tmpvar_7 - _Cutoff);
  if ((x_10 < 0.0)) {
    discard;
  ...
  v_24.z = tmpvar_16[2].z;
  mediump float tmpvar_25;
  tmpvar_25 = max (0.0, dot (tmpvar_9, normalize((normalize((((scalePerBasisVector_18.x * v_22) + (scalePerBasisVector_18.y * v_23)) + (scalePerBasisVector_18.z * v_24))) + viewDir_14))));
  nh_15 = tmpvar_25;
  ...
  spec_30 = tmpvar_31;
  mediump vec3 tmpvar_32;
  tmpvar_32 = ((tmpvar_6 * tmpvar_28.xyz) + ((tmpvar_28.xyz * _SpecColor.xyz) * spec_30));
  c_29.xyz = tmpvar_32;
...
void main ()
{
  ...
  mediump float tmpvar_27;
  tmpvar_27 = max (0.0, dot (normal_9, normalize((normalize((((scalePerBasisVector_20.x * v_24) + (scalePerBasisVector_20.y * v_25)) + (scalePerBasisVector_20.z * v_26))) + viewDir_16))));
  nh_17 = tmpvar_27;
  mediump float arg1_28;
  arg1_28 = (_Shininess * 128.0);
  highp vec4 tmpvar_29;
  ...
  tmpvar_34 = ((tmpvar_6 * tmpvar_30.xyz) + ((tmpvar_30.xyz * _SpecColor.xyz) * spec_32));
  c_31.xyz = tmpvar_34;
  c_31.w = (tmpvar_7 + (spec_32 * _SpecColor.w));
  c_2 = c_31;
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 29 to 78, TEX: 2 to 5
//   d3d9 - ALU: 40 to 91, TEX: 3 to 6
//   d3d11 - ALU: 20 to 54, TEX: 2 to 5, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
Vector 0 [_Time]
Vector 1 [_SpecColor]
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

abaaaaaajgahbaaaaaaaaaaaegacbaaaacaaaaaadoaaaaab"
}
...
mul r0.z, r0.w, r0.x
add r0.w, v0.x, -c3.x
mad r0.x, r0.w, r0, -r2.w
mad r0.z, r0.w, r0.y, r0
mov r0.y, c2.x
add r0.x, -r0, c3
mad r0.x, c0.y, r0.y, r0
add r0.z, -r0, c3.y
...
SubProgram "d3d11 " {
Keywords { "LIGHTMAP_ON" "DIRLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
ConstBuffer "$Globals" 208 // 196 used size, 13 vars
Vector 32 [_SpecColor] 4
Vector 48 [_PanMT] 4
Vector 64 [_RotMT] 4
Vector 80 [_Color] 4
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedonkkcffmphogkgfoaapchnkdldfmkikhabaaaaaahiagaaaaadaaaaaa
cmaaaaaammaaaaaaaaabaaaaejfdeheojiaaaaaaafaaaaaaaiaaaaaaiaaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaaimaaaaaaaaaaaaaaaaaaaaaa
...

...

...

...
MUL R2.xyz, R0, c[8].w;
MUL R0.xyz, R2.y, c[9];
MAD R1.xyz, R2.x, c[10], R0;
MAD R1.xyz, R2.z, c[8], R1;
DP3 R0.y, R1, R1;
RSQ R0.z, R0.y;
MOV R0.x, c[3].w;
...
mul r1.x, r2.z, r2
add r1.z, v0.x, -c3.x
mad r1.x, r1.z, r2.y, r1
mad r1.z, r1, r2.x, -r1.y
mul_pp r2.xyz, r0, c1
add r1.x, -r1, c3.y
mov r1.y, c2
mad r1.y, c0, r1, r1.x
...
SetTexture 3 [unity_Lightmap] 2D 3
SetTexture 4 [unity_LightmapInd] 2D 4
// 62 instructions, 5 temp regs, 0 temp arrays:
// ALU 54 float, 0 int, 0 uint
// TEX 5 (0 load, 0 comp, 0 bias, 0 grad)
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...

...
dkaabaaaacaaaaaaabeaaaaaaaaaaaebdiaaaaahhcaabaaaacaaaaaaegacbaaa
acaaaaaapgapbaaaacaaaaaadiaaaaahhcaabaaaacaaaaaapgapbaaaabaaaaaa
egacbaaaacaaaaaadiaaaaakhcaabaaaaeaaaaaafgafbaaaadaaaaaaaceaaaaa
...

...
abaaaaaaegaobaaaabaaaaaaaaaaaaaipcaabaaaabaaaaaaegaobaaaacaaaaaa
egaobaiaebaaaaaaabaaaaaadiaaaaaihcaabaaaacaaaaaaegacbaaaabaaaaaa
...
aaaaaaaaafaaaaaadiaaaaahhcaabaaaacaaaaaapgapbaaaabaaaaaaegacbaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

egacbaaaabaaaaaajgahbaaaaaaaaaaaegacbaaaacaaaaaadoaaaaab"
}
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...

...

...
mul_pp r2.xyz, r0.w, r2
mad_pp oC0.xyz, r0, r1, r2
mul_pp r0.y, r1.w, c4.w
cmp r0.x, r2.w, c7.w, c7.y
mov_pp r1, -r0.x
mad_pp oC0.w, r0, c1, r0.y
texkill r1.xyzw
"
}
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...

egacbaaaaaaaaaaaegacbaaaabaaaaaaegacbaaaacaaaaaadoaaaaab"
}
...
FallBack "Animated/Built-in/Transparent/Cutout/Bumped Diffuse"
}
