Shader "Animated/Built-in/Transparent/Specular" {
Properties {
	_Color ("Main Color", Color) = (1,1,1,1)
	_SpecColor ("Specular Color", Color) = (0.5, 0.5, 0.5, 0)
	_Shininess ("Shininess", Range (0.01, 1)) = 0.078125
	_MainTex ("Base (RGB) TransGloss (A)", 2D) = "white" {}
	_PanMT("Pan <Base (RGB) TransGloss (A)> (Speed(XY))", Vector) = (0,0,0,0)
	_RotMT("Rot <Base (RGB) TransGloss (A)> (Pivot(XY), Angle Speed(Z), Angle(W))", Vector) = (0.5,0.5,0,0)
}
...
//   opengl - ALU: 6 to 60
//   d3d9 - ALU: 6 to 60
//   d3d11 - ALU: 6 to 45, TEX: 0 to 0, FLOW: 1 to 1
SubProgram "opengl " {
...
Program "fp" {
// Fragment combos: 3
//   opengl - ALU: 24 to 46, TEX: 1 to 3
//   d3d9 - ALU: 33 to 57, TEX: 1 to 3
//   d3d11 - ALU: 15 to 38, TEX: 1 to 3, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" }
Vector 0 [_Time]
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedhgbfilonkboakljegggodnmmfeijflbgabaaaaaabmagaaaaadaaaaaa
...
fdeieefcbeafaaaaeaaaaaaaefabaaaafjaaaaaeegiocaaaaaaaaaaaahaaaaaa
...

...
def c9, 128.00000000, 2.00000000, 0, 0
dcl_texcoord0 v0.xy
dcl_texcoord1 v1.xyz
dcl_texcoord2 v2.xyz
dcl_texcoord3 v3.xyz
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedeiflikcfnjiigpobgooeofbacndbbdoiabaaaaaaliagaaaaadaaaaaa
...
adaaaaaaaaaaaaaaapaaaaaafdfgfpfegbhcghgfheaaklklfdeieefcjiafaaaa
eaaaaaaaggabaaaafjaaaaaeegiocaaaaaaaaaaaalaaaaaafjaaaaaeegiocaaa
...
ccaabaaaaaaaaaaabkaabaaaaaaaaaaadkaabaaaabaaaaaadiaaaaajhcaabaaa
...
mov_pp r0.y, c6.x
mad r0.x, r0, c8, c8.y
mul_pp r1.z, c9.x, r0.y
frc r1.y, r0.x
pow r0, r1.x, r1.z
mad r0.y, r1, c8.z, c8.w
sincos r1.xy, r0.y
mov r1.z, r0.x
add r0.x, v0.y, -c4.y
mul r0.y, r0.x, r1
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
feeffiedepepfceeaaklklklepfdeheocmaaaaaaabaaaaaaaiaaaaaacaaaaaaa
aaaaaaaaaaaaaaaaadaaaaaaaaaaaaaaapaaaaaafdfgfpfegbhcghgfheaaklkl
fdeieefcniaeaaaaeaaaaaaadgabaaaafjaaaaaeegiocaaaaaaaaaaaahaaaaaa
...
aaaaaaaaacaaaaaadiaaaaahhcaabaaaaaaaaaaaagaabaaaaaaaaaaajgahbaaa
aaaaaaaadiaaaaaihcaabaaaabaaaaaaegacbaaaabaaaaaaegiccaaaaaaaaaaa
afaaaaaadiaaaaaiiccabaaaaaaaaaaadkaabaaaabaaaaaadkiacaaaaaaaaaaa
...
MAD R2.xy, fragment.texcoord[4], R0.w, c[8].y;
TEX R0.w, R2, texture[1], 2D;
MOV R0.xyz, c[2];
SLT R2.x, c[7].w, fragment.texcoord[4].z;
MUL R0.xyz, R0, c[1];
...
rcp r0.x, v4.w
mad r3.xy, v4, r0.x, c8.y
dp3 r0.x, v4, v4
texld r0.w, r3, s1
cmp r0.y, -v4.z, c7.w, c7
mul_pp r0.y, r0, r0.w
texld r0.x, r0.x, s2
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...

...
MUL R2.x, R1.w, R0.w;
MUL R1, R1.yzwx, c[5].yzwx;
MUL R0.yzw, R1.xwxy, c[1].xxyz;
...
MUL R0.w, R1, R0;
MOV R2.yzw, c[2].xxyz;
MUL R1.xyw, R2.yzzw, c[1].xyzz;
MUL R0.w, R0, c[8].y;
MAD R0.xyz, R1.xyww, R2.x, R0;
MUL result.color.xyz, R0, R0.w;
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedmceapcfkpimajfnibnohidpfaagnglmhabaaaaaagaagaaaaadaaaaaa
cmaaaaaaoeaaaaaabiabaaaaejfdeheolaaaaaaaagaaaaaaaiaaaaaajiaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaakeaaaaaaaaaaaaaaaaaaaaaa
...

...
Fallback "Animated/Built-in/Transparent/Diffuse"
}
