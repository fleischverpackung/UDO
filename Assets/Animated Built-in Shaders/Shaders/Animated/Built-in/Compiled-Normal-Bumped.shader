Shader "Animated/Built-in/Bumped Diffuse" {
Properties {
...
void main ()
{
  ...
  lowp vec4 c_5;
  c_5.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * (max (0.0, dot (((texture2D (_BumpMap, tmpvar_4).xyz * 2.0) - 1.0), xlv_TEXCOORD1)) * 2.0));
  c_5.w = tmpvar_3.w;
  c_1.w = c_5.w;
...
void main ()
{
  ...
  lowp vec4 c_6;
  c_6.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * (max (0.0, dot (normal_5, xlv_TEXCOORD1)) * 2.0));
  c_6.w = tmpvar_3.w;
  c_1.w = c_6.w;
...
void main ()
{
  ...
  c_1.xyz = (tmpvar_3.xyz * ((8.0 * tmpvar_6.w) * tmpvar_6.xyz));
  c_1.w = tmpvar_3.w;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_5 = tmpvar_10;
  lowp vec4 c_11;
  c_11.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.0, dot (((texture2D (_BumpMap, tmpvar_4).xyz * 2.0) - 1.0), xlv_TEXCOORD1)) * tmpvar_5) * 2.0));
  c_11.w = tmpvar_3.w;
  c_1.w = c_11.w;
...
void main ()
{
  ...
  normal_5.z = sqrt((1.0 - clamp (dot (normal_5.xy, normal_5.xy), 0.0, 1.0)));
  lowp vec4 c_6;
  c_6.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.0, dot (normal_5, xlv_TEXCOORD1)) * texture2DProj (_ShadowMapTexture, xlv_TEXCOORD3).x) * 2.0));
  c_6.w = tmpvar_3.w;
  c_1.w = c_6.w;
  c_1.xyz = (c_6.xyz + (tmpvar_3.xyz * xlv_TEXCOORD2));
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  c_1.xyz = (tmpvar_3.xyz * max (min (tmpvar_8, ((tmpvar_6.x * 2.0) * tmpvar_7.xyz)), (tmpvar_8 * tmpvar_6.x)));
  c_1.w = tmpvar_3.w;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec3 tmpvar_18;
  tmpvar_18 = vec3((tmpvar_6 * 2.0));
  mediump vec3 tmpvar_19;
  tmpvar_19 = (tmpvar_3.xyz * min (lm_15, tmpvar_18));
  c_1.xyz = tmpvar_19;
  c_1.w = tmpvar_3.w;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec3 arg1_15;
  arg1_15 = ((tmpvar_6.x * 2.0) * tmpvar_7.xyz);
  mediump vec3 tmpvar_16;
  tmpvar_16 = (tmpvar_3.xyz * max (min (lm_12, arg1_15), (lm_12 * tmpvar_6.x)));
  c_1.xyz = tmpvar_16;
  c_1.w = tmpvar_3.w;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  shadow_5 = tmpvar_7;
  lowp vec4 c_8;
  c_8.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.0, dot (((texture2D (_BumpMap, tmpvar_4).xyz * 2.0) - 1.0), xlv_TEXCOORD1)) * shadow_5) * 2.0));
  c_8.w = tmpvar_3.w;
  c_1.w = c_8.w;
...
void main ()
{
  ...
  lm_12 = (lm_12 * dot (clamp ((tmpvar_9 * normal_10), 0.0, 1.0), scalePerBasisVector_11));
  lowp vec3 tmpvar_15;
  tmpvar_15 = vec3((shadow_6 * 2.0));
  mediump vec3 tmpvar_16;
  tmpvar_16 = (tmpvar_3.xyz * min (lm_12, tmpvar_15));
  c_1.xyz = tmpvar_16;
  c_1.w = tmpvar_3.w;
  gl_FragData[0] = c_1;
}
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 24 to 55, TEX: 2 to 5
//   d3d9 - ALU: 33 to 63, TEX: 2 to 5
//   d3d11 - ALU: 14 to 33, TEX: 2 to 5, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_Time]
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedefgcdpdobkdjpmncpcgckbggdcgedjababaaaaaabmafaaaaadaaaaaa
...
aaaaaaaaafaaaaaadcaaaaapdcaabaaaaaaaaaaahgapbaaaaaaaaaaaaceaaaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefieceddcbhmcpildcmhelikggijbfnpecfieieabaaaaaammadaaaaadaaaaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedomgidmikdicejodfidcmeoohgcbbcfokabaaaaaaaaagaaaaadaaaaaa
cmaaaaaajmaaaaaanaaaaaaaejfdeheogiaaaaaaadaaaaaaaiaaaaaafaaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaafmaaaaaaaaaaaaaaaaaaaaaa
...

...
aaaaaaaaegacbaaaadaaaaaaegacbaaaaaaaaaaaefaaaaajpcaabaaaabaaaaaa
egbabaaaacaaaaaaeghobaaaacaaaaaaaagabaaaacaaaaaadiaaaaahccaabaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedgamcjfpjmmfnappdkgkhcbfobobkkhpfabaaaaaajmafaaaaadaaaaaa
...
fdeieefcjeaeaaaaeaaaaaaacfabaaaafjaaaaaeegiocaaaaaaaaaaaakaaaaaa
...

...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedfkinceahhaianjmogdphgnjmfdfoeiecabaaaaaapmaeaaaaadaaaaaa
cmaaaaaaleaaaaaaoiaaaaaaejfdeheoiaaaaaaaaeaaaaaaaiaaaaaagiaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaaheaaaaaaaaaaaaaaaaaaaaaa
...
texld r1.yw, r1, s1
mad_pp r2.xy, r1.wyzw, c6.x, c6.y
...
rsq_pp r0.z, r0.z
rcp_pp r2.z, r0.z
dp3_pp_sat r3.x, r2, c9
dp3_pp_sat r3.z, r2, c7
dp3_pp_sat r3.y, r2, c8
mul_pp r1.xyz, r1, r3
dp3_pp r0.z, r1, c4.w
texldp r3.x, v2, s2
texld r2, v1, s3
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...

...
adaaaaaadiaaaaahhcaabaaaabaaaaaaegacbaaaabaaaaaapgapbaaaaaaaaaaa
...
void main ()
{
  ...
  tmpvar_18 = (tmpvar_5.xyz * tmpvar_16.xyz);
  c_17.xyz = tmpvar_18;
  c_17.w = tmpvar_5.w;
  c_2 = c_17;
  tmpvar_1 = c_2;
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 23 to 53, TEX: 2 to 5
//   d3d9 - ALU: 32 to 61, TEX: 2 to 5
//   d3d11 - ALU: 14 to 29, TEX: 2 to 5, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
Vector 0 [_Time]
Vector 1 [_PanMT]
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedngfbahckomdcefikegfcimpnbblenjebabaaaaaammafaaaaadaaaaaa
cmaaaaaammaaaaaaaaabaaaaejfdeheojiaaaaaaafaaaaaaaiaaaaaaiaaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaaimaaaaaaaaaaaaaaaaaaaaaa
...

...
abaaaaaaegaobaaaabaaaaaaegiocaaaaaaaaaaaafaaaaaadiaaaaahhccabaaa
aaaaaaaaegacbaaaaaaaaaaaegacbaaaabaaaaaadgaaaaaficcabaaaaaaaaaaa
...
SubProgram "d3d11 " {
Keywords { "LIGHTMAP_ON" "DIRLIGHTMAP_ON" "HDR_LIGHT_PREPASS_OFF" }
ConstBuffer "$Globals" 176 // 96 used size, 11 vars
Vector 48 [_PanMT] 4
Vector 64 [_RotMT] 4
Vector 80 [_Color] 4
ConstBuffer "UnityPerCamera" 128 // 16 used size, 8 vars
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
agbbbaaaacaaaaaapgbpbaaaacaaaaaaefaaaaajpcaabaaaabaaaaaajgafbaaa
aaaaaaaaeghobaaaacaaaaaaaagabaaaacaaaaaacpaaaaafocaabaaaaaaaaaaa
agajbaaaabaaaaaaefaaaaajpcaabaaaabaaaaaaegbabaaaadaaaaaaeghobaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
aaaaaaaaagaabaaaaaaaaaaaegacbaaaabaaaaaadiaaaaahhccabaaaaaaaaaaa
