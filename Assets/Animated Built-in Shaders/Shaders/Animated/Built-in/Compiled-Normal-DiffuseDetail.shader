Shader "Animated/Built-in/Diffuse Detail" {
Properties {
	...
	_PanD("Pan <Detail (RGB)> (Speed(XY))", Vector) = (0,0,0,0)
	_RotD("Rot <Detail (RGB)> (Pivot(XY), Angle Speed(Z), Angle(W))", Vector) = (0.5,0.5,0,0)
}
...
uniform highp vec4 _RotD;
uniform highp vec4 _PanD;
...
void main ()
{
  ...
  c_2.w = tmpvar_4.w;
  highp vec2 tmpvar_5;
  tmpvar_5.x = ((_RotD.x - (((xlv_TEXCOORD0.z - _RotD.x) * cos(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))) - ((xlv_TEXCOORD0.w - _RotD.y) * sin(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))))) + (_PanD.x * _Time.y));
  tmpvar_5.y = ((_RotD.y - (((xlv_TEXCOORD0.z - _RotD.x) * sin(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))) + ((xlv_TEXCOORD0.w - _RotD.y) * cos(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))))) + (_PanD.y * _Time.y));
  c_2.xyz = (tmpvar_4.xyz * (texture2D (_Detail, tmpvar_5).xyz * 2.0));
  lowp vec4 c_6;
...
v2f_surf vert_surf( in appdata_full v ) {
    ...
    o.pack0.zw = ((v.texcoord.xy * _Detail_ST.xy) + _Detail_ST.zw);
    #line 429
...
void surf( in Input IN, inout SurfaceOutput o ) {
    ...
    #line 408
    highp vec2 UV_PanD = vec2( ((_RotD.x - (((IN.uv_Detail.x - _RotD.x) * cos(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))) - ((IN.uv_Detail.y - _RotD.y) * sin(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))))) + (_PanD.x * _Time.y)), ((_RotD.y - (((IN.uv_Detail.x - _RotD.x) * sin(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))) + ((IN.uv_Detail.y - _RotD.y) * cos(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))))) + (_PanD.y * _Time.y)));
    c.xyz *= (texture( _Detail, UV_PanD).xyz * 2.0);
    o.Albedo = c.xyz;
    o.Alpha = c.w;
}
#line 436
...
//   d3d11 - ALU: 27 to 33, TEX: 2 to 4, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_Time]
...
MUL R0.y, R0.x, c[8];
MOV R0.x, c[0].y;
MAD R0.y, R0.x, c[6].z, R0;
SIN R1.y, R0.y;
COS R0.w, R0.y;
ADD R0.y, fragment.texcoord[0].w, -c[6];
MUL R0.z, R0.y, R1.y;
...
ADD R0.z, -R0, c[6].x;
MOV R0.y, c[4].w;
MAD R0.y, R0, c[8].x, c[8].z;
ADD R0.w, -R0, c[6].y;
MUL R0.y, R0, c[8];
MAD R0.y, R0.x, c[4].z, R0;
MAD R0.z, R0.x, c[5].x, R0;
MAD R0.w, R0.x, c[5].y, R0;
...
dcl_2d s0
dcl_2d s1
def c8, 0.00555556, 1.00000000, 3.14159274, 2.00000000
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedhiifjcofbcoillfnedgloggkjdbljjkaabaaaaaafeagaaaaadaaaaaa
...

...
COS R0.y, R0.x;
SIN R2.x, R0.x;
ADD R2.y, fragment.texcoord[0].w, -c[4];
MUL R0.x, R2.y, R2;
ADD R0.w, fragment.texcoord[0].z, -c[4].x;
...
MUL R0.w, R0.y, c[6].y;
MAD R0.y, R0.z, c[3], R2.x;
TEX R2.xyz, R0, texture[1], 2D;
MAD R0.w, R0.z, c[2].z, R0;
COS R0.x, R0.w;
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedhiphfebjmikgbkhemaneehddeomoafklabaaaaaapmafaaaaadaaaaaa
...
aaaaaaaaegacbaaaaaaaaaaaegacbaaaaaaaaaaadcaaaaakicaabaaaaaaaaaaa
...
aeaaaaaadiaaaaahjcaabaaaabaaaaaaagaabaaaabaaaaaafgajbaaaabaaaaaa
...
abaaaaaaegiocaaaaaaaaaaaahaaaaaadiaaaaahhcaabaaaaaaaaaaaegacbaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecednegobmlffmglooilecjebhnfncafngccabaaaaaaneagaaaaadaaaaaa
...
fdeieefcmmafaaaaeaaaaaaahdabaaaafjaaaaaeegiocaaaaaaaaaaaamaaaaaa
...
aaaaaaaaakaabaaaaaaaaaaaefaaaaajpcaabaaaaaaaaaaaegaabaaaabaaaaaa
eghobaaaabaaaaaaaagabaaaacaaaaaaaaaaaaahhcaabaaaaaaaaaaaegacbaaa
aaaaaaaaegacbaaaaaaaaaaadcaaaaakicaabaaaaaaaaaaadkiacaaaaaaaaaaa
...

...
SIN R2.w, R1.w;
COS R3.x, R1.w;
ADD R3.y, fragment.texcoord[0].w, -c[4];
ADD R1.w, fragment.texcoord[0].z, -c[4].x;
MUL R2.y, R3, R2.w;
MAD R2.y, R1.w, R3.x, -R2;
MUL R1.xyz, R1, c[7].x;
MUL R0.xyz, R0, c[6].w;
MIN R0.xyz, R1, R0;
MUL R1.xyz, R1, R2.x;
...
MAX R2.xyz, R0, R1;
MUL R0.z, R3.x, R3.y;
MAD R0.z, R1.w, R2.w, R0;
MOV R0.y, c[2].w;
MAD R0.x, R0.w, c[3], R3.z;
ADD R1.x, -R0.z, c[4].y;
MAD R0.y, R0, c[6].x, c[6].z;
MUL R0.z, R0.y, c[6].y;
MAD R0.y, R0.w, c[3], R1.x;
...
MUL R2.w, R0.x, R0.y;
ADD R0.y, fragment.texcoord[0].x, -c[2].x;
MAD R0.x, R0.y, R0, -R1.w;
MAD R0.z, R0.y, R0, R2.w;
ADD R0.y, -R0.z, c[2];
ADD R0.x, -R0, c[2];
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
bkiacaaaabaaaaaaaaaaaaaaakaabaaaaaaaaaaaefaaaaajpcaabaaaaaaaaaaa
egaabaaaabaaaaaaeghobaaaabaaaaaaaagabaaaacaaaaaaaaaaaaahhcaabaaa
aaaaaaaaegacbaaaaaaaaaaaegacbaaaaaaaaaaadcaaaaakicaabaaaaaaaaaaa
...
abaaaaaaegiocaaaaaaaaaaaalaaaaaadiaaaaahhcaabaaaaaaaaaaaegacbaaa
aaaaaaaaegacbaaaabaaaaaadgaaaaaficcabaaaaaaaaaaadkaabaaaabaaaaaa
...
COS R3.x, R1.w;
SIN R3.y, R1.w;
ADD R2.w, fragment.texcoord[0], -c[4].y;
ADD R1.w, fragment.texcoord[0].z, -c[4].x;
MUL R2.y, R2.w, R3;
MAD R2.y, R1.w, R3.x, -R2;
MUL R1.xyz, R1, c[7].x;
...
void main ()
{
  ...
  c_3.w = tmpvar_5.w;
  highp vec2 tmpvar_6;
  tmpvar_6.x = ((_RotD.x - (((xlv_TEXCOORD0.z - _RotD.x) * cos(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))) - ((xlv_TEXCOORD0.w - _RotD.y) * sin(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))))) + (_PanD.x * _Time.y));
  tmpvar_6.y = ((_RotD.y - (((xlv_TEXCOORD0.z - _RotD.x) * sin(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))) + ((xlv_TEXCOORD0.w - _RotD.y) * cos(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))))) + (_PanD.y * _Time.y));
  c_3.xyz = (tmpvar_5.xyz * (texture2D (_Detail, tmpvar_6).xyz * 2.0));
...
MAD R0.x, R0.z, R0.y, -R0;
MUL R0.y, R0, R1;
MAD R0.y, R0.z, R1.x, R0;
MOV R1.y, c[5].w;
MAD R0.z, R1.y, c[7].x, c[7].w;
MUL R0.z, R0, c[7];
MAD R1.x, R0.w, c[5].z, R0.z;
ADD R0.x, -R0, c[3];
ADD R0.y, -R0, c[3];
COS R1.y, R1.x;
SIN R1.z, R1.x;
ADD R1.x, fragment.texcoord[0].w, -c[5].y;
MUL R1.w, R1.x, R1.z;
MUL R2.x, R1.y, R1;
ADD R1.x, fragment.texcoord[0].z, -c[5];
...
dcl_2d s1
dcl_2d s2
def c7, 0.00555556, 1.00000000, 3.14159274, 2.00000000
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
feeffiedepepfceeaaklklklepfdeheocmaaaaaaabaaaaaaaiaaaaaacaaaaaaa
aaaaaaaaaaaaaaaaadaaaaaaaaaaaaaaapaaaaaafdfgfpfegbhcghgfheaaklkl
fdeieefcoaafaaaaeaaaaaaahiabaaaafjaaaaaeegiocaaaaaaaaaaaamaaaaaa
...
agaabaaaabaaaaaaeghobaaaacaaaaaaaagabaaaaaaaaaaaapaaaaahicaabaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
MAD R1.zw, fragment.texcoord[3].xyxy, R0.w, c[8].y;
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
hcaabaaaaaaaaaaaegacbaaaaaaaaaaaegiccaaaaaaaaaaaalaaaaaadcaaaaak
...
egaabaaaabaaaaaaeghobaaaabaaaaaaaagabaaaadaaaaaaaaaaaaahhcaabaaa
abaaaaaaegacbaaaabaaaaaaegacbaaaabaaaaaadiaaaaahhcaabaaaaaaaaaaa
...
adaaaaaaaagabaaaabaaaaaadiaaaaahicaabaaaaaaaaaaadkaabaaaaaaaaaaa
...
abaaaaaaagaabaaaabaaaaaaegbcbaaaadaaaaaabaaaaaahbcaabaaaabaaaaaa
...
ADD R1.y, -R1, c[3].x;
MOV R0.z, c[5].w;
MAD R0.z, R0, c[7].x, c[7].w;
MUL R1.x, R0.z, c[7].z;
ADD R0.y, -R0, c[3];
MAD R1.w, R0, c[5].z, R1.x;
MAD R0.x, R0.w, c[2], R1.y;
MAD R0.y, R0.w, c[2], R0;
TEX R0.xyz, R0, texture[0], 2D;
MUL R1.xyz, R0, c[6];
COS R0.x, R1.w;
...
MAD R0.x, R0.y, R0, -R1.w;
MAD R0.z, R0.y, R0, R2.x;
ADD R0.y, -R0.z, c[5];
ADD R0.x, -R0, c[5];
MAD R0.y, R0.w, c[4], R0;
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
egbcbaaaaeaaaaaaeghobaaaadaaaaaaaagabaaaaaaaaaaadiaaaaahbcaabaaa
...
ADD R0.z, -R0, c[5].x;
MOV R0.y, c[3].w;
MAD R0.y, R0, c[7].x, c[7].w;
ADD R0.w, -R0, c[5].y;
MUL R0.y, R0, c[7].z;
MAD R0.y, R0.x, c[3].z, R0;
MAD R0.z, R0.x, c[4].x, R0;
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
void main ()
{
  ...
  lowp vec4 tmpvar_6;
  tmpvar_6 = (texture2D (_MainTex, tmpvar_5) * _Color);
  c_4.w = tmpvar_6.w;
  highp vec2 tmpvar_7;
  tmpvar_7.x = ((_RotD.x - (((xlv_TEXCOORD0.z - _RotD.x) * cos(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))) - ((xlv_TEXCOORD0.w - _RotD.y) * sin(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))))) + (_PanD.x * _Time.y));
  tmpvar_7.y = ((_RotD.y - (((xlv_TEXCOORD0.z - _RotD.x) * sin(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))) + ((xlv_TEXCOORD0.w - _RotD.y) * cos(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))))) + (_PanD.y * _Time.y));
  c_4.xyz = (tmpvar_6.xyz * (texture2D (_Detail, tmpvar_7).xyz * 2.0));
  lowp vec4 tmpvar_8;
...
void main ()
{
  ...
  lowp vec4 tmpvar_9;
  tmpvar_9 = (texture2D (_MainTex, tmpvar_8) * _Color);
  c_7.w = tmpvar_9.w;
  highp vec2 tmpvar_10;
  tmpvar_10.x = ((_RotD.x - (((xlv_TEXCOORD0.z - _RotD.x) * cos(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))) - ((xlv_TEXCOORD0.w - _RotD.y) * sin(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))))) + (_PanD.x * _Time.y));
  tmpvar_10.y = ((_RotD.y - (((xlv_TEXCOORD0.z - _RotD.x) * sin(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))) + ((xlv_TEXCOORD0.w - _RotD.y) * cos(((_RotD.z * _Time.y) + (3.14159 * (1.0 + (_RotD.w / 180.0)))))))) + (_PanD.y * _Time.y));
  c_7.xyz = (tmpvar_9.xyz * (texture2D (_Detail, tmpvar_10).xyz * 2.0));
  lowp vec4 tmpvar_11;
...
//   d3d9 - ALU: 62 to 74, TEX: 3 to 5
//   d3d11 - ALU: 27 to 36, TEX: 3 to 5, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
Vector 0 [_Time]
Vector 1 [_PanMT]
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
aaaaaaaaegaabaaaabaaaaaaeghobaaaabaaaaaaaagabaaaabaaaaaaaaaaaaah
hcaabaaaaaaaaaaaegacbaaaaaaaaaaaegacbaaaaaaaaaaadcaaaaakicaabaaa
...
COS R2.y, R1.w;
SIN R1.w, R1.w;
ADD R2.z, fragment.texcoord[0].w, -c[4].y;
MUL R1.x, R2.z, R1.w;
ADD R2.x, fragment.texcoord[0].z, -c[4];
MAD R2.w, R2.x, R2.y, -R1.x;
...
ADD R1.xyz, -R1, R0;
MUL R0.y, R2, R2.z;
MAD R0.y, R2.x, R1.w, R0;
MOV R0.z, c[2].w;
MAD R0.z, R0, c[7].x, c[7];
MUL R0.z, R0, c[7].y;
MAD R1.w, R0, c[2].z, R0.z;
ADD R0.y, -R0, c[4];
COS R2.y, R1.w;
SIN R2.z, R1.w;
ADD R1.w, fragment.texcoord[0].y, -c[2].y;
...
MAD R2.z, R1.w, R2, R2.w;
ADD R1.w, -R2.z, c[2].y;
ADD R2.x, -R2, c[2];
MAD R2.y, R0.w, c[1], R1.w;
MAD R2.x, R0.w, c[1], R2;
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
abaaaaaaaoaaaaahdcaabaaaabaaaaaaegbabaaaacaaaaaapgbpbaaaacaaaaaa
efaaaaajpcaabaaaabaaaaaaegaabaaaabaaaaaaeghobaaaacaaaaaaaagabaaa
acaaaaaaaaaaaaahhcaabaaaabaaaaaaegacbaaaabaaaaaaegbcbaaaadaaaaaa
...
MUL R0.xyz, R0.w, R0;
MUL R0.xyz, R0, c[8].x;
MAD R2.xyz, R1, c[8].x, -R0;
MOV R1.w, c[4];
MAD R0.w, R1, c[7].x, c[7].z;
MUL R1.w, R0, c[7].y;
MOV R0.w, c[0].y;
MAD R1.w, R0, c[4].z, R1;
DP4 R1.y, fragment.texcoord[3], fragment.texcoord[3];
RSQ R1.y, R1.y;
RCP R3.x, R1.y;
MAD_SAT R3.x, R3, c[6].z, c[6].w;
...
MAD R2.w, R1.y, R1.x, -R2;
MUL R0.z, R1.x, R1.w;
MAD R0.z, R1.y, R1, R0;
ADD R2.w, -R2, c[4].x;
MAD R0.x, R0.w, c[3], R2.w;
ADD R1.x, -R0.z, c[4].y;
MAD R0.y, R0, c[7].x, c[7].z;
MUL R0.z, R0.y, c[7].y;
MAD R0.y, R0.w, c[3], R1.x;
TEX R1.xyz, R0, texture[1], 2D;
MAD R0.z, R0.w, c[2], R0;
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
// FLOW 1 static, 0 dynamic
"ps_4_0

