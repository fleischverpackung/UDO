Shader "Animated/Built-in/Self-Illumin/Bumped Diffuse" {
Properties {
...
//   opengl - ALU: 8 to 72
//   d3d9 - ALU: 8 to 75
//   d3d11 - ALU: 8 to 59, TEX: 0 to 0, FLOW: 1 to 1
SubProgram "opengl " {
...
"vs_4_0
eefiecedhgjhelgmikmbpaonjknngmelcnkafdloabaaaaaanaagaaaaadaaaaaa
...
enabaaaafjaaaaaeegiocaaaaaaaaaaaalaaaaaafjaaaaaeegiocaaaabaaaaaa
...
void main ()
{
  ...
  lowp vec4 c_6;
  c_6.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * (max (0.0, dot (((texture2D (_BumpMap, tmpvar_5).xyz * 2.0) - 1.0), xlv_TEXCOORD2)) * 2.0));
  c_6.w = tmpvar_3.w;
  c_1.w = c_6.w;
  c_1.xyz = (c_6.xyz + (tmpvar_3.xyz * xlv_TEXCOORD3));
...
void main ()
{
  ...
  lowp vec4 c_7;
  c_7.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * (max (0.0, dot (normal_6, xlv_TEXCOORD2)) * 2.0));
  c_7.w = tmpvar_3.w;
  c_1.w = c_7.w;
...
// FLOW 1 static, 0 dynamic
"vs_4_0
eefiecedhnjhjknfehpobiflhlgcigiojidcedoaabaaaaaafiadaaaaadaaaaaa
...
neabaaaaeaaaabaahfaaaaaafjaaaaaeegiocaaaaaaaaaaaamaaaaaafjaaaaae
...
aaaaaaaaalaaaaaadcaaaaalmccabaaaacaaaaaaagbebaaaaeaaaaaaagiecaaa
aaaaaaaaaiaaaaaakgiocaaaaaaaaaaaaiaaaaaadoaaaaab"
}
...
// FLOW 1 static, 0 dynamic
"vs_4_0
eefiecedjinfhgggmifmohombkfcphfbijfjpechabaaaaaajaahaaaaadaaaaaa
...
aoaaaaaaogikcaaaaaaaaaaaaoaaaaaadiaaaaahhcaabaaaabaaaaaajgbebaaa
...
void main ()
{
  ...
  tmpvar_6 = tmpvar_11;
  lowp vec4 c_12;
  c_12.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.0, dot (((texture2D (_BumpMap, tmpvar_5).xyz * 2.0) - 1.0), xlv_TEXCOORD2)) * tmpvar_6) * 2.0));
  c_12.w = tmpvar_3.w;
  c_1.w = c_12.w;
  c_1.xyz = (c_12.xyz + (tmpvar_3.xyz * xlv_TEXCOORD3));
  c_1.xyz = (c_1.xyz + (tmpvar_3.xyz * texture2D (_Illum, tmpvar_4).w));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  normal_6.z = sqrt((1.0 - clamp (dot (normal_6.xy, normal_6.xy), 0.0, 1.0)));
  lowp vec4 c_7;
  c_7.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.0, dot (normal_6, xlv_TEXCOORD2)) * texture2DProj (_ShadowMapTexture, xlv_TEXCOORD4).x) * 2.0));
  c_7.w = tmpvar_3.w;
  c_1.w = c_7.w;
  c_1.xyz = (c_7.xyz + (tmpvar_3.xyz * xlv_TEXCOORD3));
  c_1.xyz = (c_1.xyz + (tmpvar_3.xyz * texture2D (_Illum, tmpvar_4).w));
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
jpaaaaaafjaaaaaeegiocaaaaaaaaaaabaaaaaaafjaaaaaeegiocaaaabaaaaaa
...
apaaaaaaogikcaaaaaaaaaaaapaaaaaadcaaaaalmccabaaaacaaaaaaagbebaaa
...
void main ()
{
  ...
  lowp vec3 tmpvar_19;
  tmpvar_19 = vec3((tmpvar_7 * 2.0));
  mediump vec3 tmpvar_20;
  tmpvar_20 = (tmpvar_3.xyz * min (lm_16, tmpvar_19));
  c_1.xyz = tmpvar_20;
  c_1.w = tmpvar_3.w;
  c_1.xyz = (c_1.xyz + (tmpvar_3.xyz * texture2D (_Illum, tmpvar_4).w));
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec3 arg1_16;
  arg1_16 = ((tmpvar_7.x * 2.0) * tmpvar_8.xyz);
  mediump vec3 tmpvar_17;
  tmpvar_17 = (tmpvar_3.xyz * max (min (lm_13, arg1_16), (lm_13 * tmpvar_7.x)));
  c_1.xyz = tmpvar_17;
  c_1.w = tmpvar_3.w;
  c_1.xyz = (c_1.xyz + (tmpvar_3.xyz * texture2D (_Illum, tmpvar_4).w));
  gl_FragData[0] = c_1;
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...

...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
void main ()
{
  ...
  shadow_6 = tmpvar_8;
  lowp vec4 c_9;
  c_9.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.0, dot (((texture2D (_BumpMap, tmpvar_5).xyz * 2.0) - 1.0), xlv_TEXCOORD2)) * shadow_6) * 2.0));
  c_9.w = tmpvar_3.w;
  c_1.w = c_9.w;
  c_1.xyz = (c_9.xyz + (tmpvar_3.xyz * xlv_TEXCOORD3));
  c_1.xyz = (c_1.xyz + (tmpvar_3.xyz * texture2D (_Illum, tmpvar_4).w));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lm_13 = (lm_13 * dot (clamp ((tmpvar_10 * normal_11), 0.0, 1.0), scalePerBasisVector_12));
  lowp vec3 tmpvar_16;
  tmpvar_16 = vec3((shadow_7 * 2.0));
  mediump vec3 tmpvar_17;
  tmpvar_17 = (tmpvar_3.xyz * min (lm_13, tmpvar_16));
  c_1.xyz = tmpvar_17;
  c_1.w = tmpvar_3.w;
  c_1.xyz = (c_1.xyz + (tmpvar_3.xyz * texture2D (_Illum, tmpvar_4).w));
  gl_FragData[0] = c_1;
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 42 to 73, TEX: 3 to 6
//   d3d9 - ALU: 62 to 92, TEX: 3 to 6
//   d3d11 - ALU: 25 to 53, TEX: 3 to 6, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
Vector 0 [_Time]
...
MOV R1.y, c[0];
MUL R0.x, R0, c[7].z;
MAD R0.x, R1.y, c[3].z, R0;
COS R1.z, R0.x;
SIN R1.w, R0.x;
ADD R0.x, fragment.texcoord[1].y, -c[3].y;
MUL R0.y, R0.x, R1.w;
MUL R0.z, R1, R0.x;
ADD R0.x, fragment.texcoord[1], -c[3];
MAD R0.z, R0.x, R1.w, R0;
MAD R0.x, R0, R1.z, -R0.y;
ADD R0.y, -R0.z, c[3];
ADD R0.x, -R0, c[3];
MAD R0.x, R1.y, c[2], R0;
MAD R0.y, R1, c[2], R0;
...
MUL R0.y, R1.z, R0.w;
MAD R0.y, R1.w, R2.x, R0;
MOV R0.z, c[5].w;
MAD R0.z, R0, c[7].x, c[7].y;
MUL R0.z, R0, c[7];
MAD R1.w, R1.y, c[5].z, R0.z;
MAD R0.x, R1.y, c[2], R2.y;
ADD R0.y, -R0, c[3];
MAD R0.y, R1, c[2], R0;
TEX R0, R0, texture[0], 2D;
MUL R0, R0, c[6];
COS R1.z, R1.w;
ADD R2.x, fragment.texcoord[0].w, -c[5].y;
SIN R2.y, R1.w;
MUL R1.w, R2.x, R2.y;
MUL R2.z, R1, R2.x;
ADD R2.x, fragment.texcoord[0].z, -c[5];
MAD R1.z, R2.x, R1, -R1.w;
MAD R2.y, R2.x, R2, R2.z;
ADD R1.w, -R2.y, c[5].y;
ADD R1.z, -R1, c[5].x;
MAD R1.w, R1.y, c[4].y, R1;
MAD R1.z, R1.y, c[4].x, R1;
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedggfojikecbdeckbcecigeoajelibjefeabaaaaaaeaaiaaaaadaaaaaa
...
fdeieefcdiahaaaaeaaaaaaamoabaaaafjaaaaaeegiocaaaaaaaaaaaaiaaaaaa
...
fgiecaiaebaaaaaaaaaaaaaaaeaaaaaadiaaaaahgcaabaaaabaaaaaaagaabaaa
...

...

...
abaaaaaadiaaaaahhcaabaaaadaaaaaaegacbaaaabaaaaaaegbcbaaaaeaaaaaa
...
COS R2.w, R0.x;
SIN R3.x, R0.x;
ADD R0.x, fragment.texcoord[1].y, -c[2].y;
MUL R0.y, R0.x, R3.x;
MUL R0.z, R2.w, R0.x;
...
MUL R0.xyz, R0.w, R0;
MUL R0.xyz, R0, R1;
ADD R2.y, fragment.texcoord[0], -c[2];
DP3 R1.x, R0, c[7].w;
TEX R0, fragment.texcoord[2], texture[3], 2D;
MUL R0.xyz, R0.w, R0;
MUL R1.y, R3.x, R2;
ADD R2.x, fragment.texcoord[0], -c[2];
MAD R1.y, R2.w, R2.x, -R1;
ADD R0.w, -R1.y, c[2].x;
MUL R1.xyz, R0, R1.x;
MUL R0.y, R2.w, R2;
MAD R0.y, R3.x, R2.x, R0;
MOV R0.z, c[4].w;
...
rcp_pp r2.z, r0.x
texld r0, v2, s4
dp3_pp_sat r1.z, r2, c9
dp3_pp_sat r1.y, r2, c10
dp3_pp_sat r1.x, r2, c11
mul_pp r0.xyz, r0.w, r0
mul_pp r1.xyz, r0, r1
texld r0, v2, s3
mul_pp r0.xyz, r0.w, r0
...
add r1.z, -r1.y, c2.x
mov r1.y, c1.x
mad r2.x, c0.y, r1.y, r1.z
mad r1.w, r1, c6.x, c6.y
mul r0.w, r3.x, r0
mad r0.w, r3.y, r1.x, r0
add r1.x, -r0.w, c2.y
mov r0.w, c1.y
mad r2.y, c0, r0.w, r1.x
mul r1.z, r1.w, c6
mov r1.y, c4.z
mad r1.y, c0, r1, r1.z
mad r1.y, r1, c7.x, c7
frc r1.y, r1
mad r2.z, r1.y, c7, c7.w
sincos r1.xy, r2.z
add r1.z, v0.w, -c4.y
mul r0.w, r1.z, r1.y
mul r1.w, r1.z, r1.x
add r1.z, v0, -c4.x
mad r1.x, r1.z, r1, -r0.w
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
ffffaaaagcbaaaadpcbabaaaabaaaaaagcbaaaaddcbabaaaacaaaaaagcbaaaad
mcbabaaaacaaaaaagfaaaaadpccabaaaaaaaaaaagiaaaaacafaaaaaaefaaaaaj
pcaabaaaaaaaaaaaogbkbaaaacaaaaaaeghobaaaaeaaaaaaaagabaaaaeaaaaaa
...

...
aeaaaaaadcaaaaalbcaabaaaadaaaaaaakiacaaaaaaaaaaaadaaaaaabkiacaaa
abaaaaaaaaaaaaaadkaabaaaaaaaaaaaefaaaaajpcaabaaaadaaaaaaegaabaaa
adaaaaaaeghobaaaacaaaaaaaagabaaaabaaaaaadcaaaaapdcaabaaaadaaaaaa
...

...

...

...
RSQ R0.z, R0.z;
RCP R0.z, R0.z;
DP3 R0.y, R0, fragment.texcoord[2];
MUL R1.z, R1.y, R1.w;
ADD R0.w, fragment.texcoord[0].x, -c[3].x;
MAD R1.z, R1.x, R0.w, -R1;
MUL R1.x, R1, R1.w;
MAD R0.w, R1.y, R0, R1.x;
MOV R1.w, c[5];
MAD R1.x, R1.w, c[7], c[7].y;
ADD R0.w, -R0, c[3].y;
ADD R1.z, -R1, c[3].x;
MAD R1.w, R2.x, c[2].y, R0;
MUL R1.x, R1, c[7].z;
MAD R0.w, R2.x, c[5].z, R1.x;
MAD R1.z, R2.x, c[2].x, R1;
TEX R1, R1.zwzw, texture[0], 2D;
MUL R1, R1, c[6];
COS R2.y, R0.w;
SIN R2.z, R0.w;
ADD R0.w, fragment.texcoord[0], -c[5].y;
MUL R2.w, R0, R2.z;
MUL R3.x, R2.y, R0.w;
ADD R0.w, fragment.texcoord[0].z, -c[5].x;
MAD R2.z, R0.w, R2, R3.x;
MAD R0.w, R0, R2.y, -R2;
ADD R2.y, -R2.z, c[5];
MAD R2.y, R2.x, c[4], R2;
ADD R0.w, -R0, c[5].x;
MAD R2.x, R2, c[4], R0.w;
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedanembfecbnbfeopkhjpmbolekchcjloiabaaaaaamaaiaaaaadaaaaaa
...
eaaaaaaaoiabaaaafjaaaaaeegiocaaaaaaaaaaaamaaaaaafjaaaaaeegiocaaa
...
pcaabaaaaaaaaaaaegaabaaaabaaaaaaeghobaaaabaaaaaaaagabaaaadaaaaaa
...

...
MOV R0.w, c[0].y;
MUL R0.x, R0, c[6].z;
MAD R0.y, R0.w, c[2].z, R0.x;
COS R2.w, R0.y;
SIN R1.w, R0.y;
ADD R0.x, fragment.texcoord[1].y, -c[2].y;
MUL R0.y, R1.w, R0.x;
ADD R0.z, fragment.texcoord[1].x, -c[2].x;
MAD R0.y, R2.w, R0.z, -R0;
MUL R0.x, R2.w, R0;
MAD R0.x, R1.w, R0.z, R0;
ADD R0.x, -R0, c[2].y;
ADD R0.y, -R0, c[2].x;
MAD R1.y, R0.w, c[1], R0.x;
MAD R1.x, R0.w, c[1], R0.y;
TEX R3.yw, R1, texture[2], 2D;
MAD R0.xy, R3.wyzw, c[6].w, -c[6].y;
MUL R1.xy, R0, R0;
...
MIN R1.xyz, R2, R1;
MUL R0.y, R3.x, R1.w;
ADD R3.y, fragment.texcoord[0].x, -c[2].x;
MAD R0.y, R3, R2.w, -R0;
ADD R3.z, -R0.y, c[2].x;
MUL R0.xyz, R2, R0.x;
MUL R2.z, R2.w, R3.x;
MAD R2.z, R3.y, R1.w, R2;
MOV R2.y, c[4].w;
MAD R1.w, R2.y, c[6].x, c[6].y;
ADD R2.y, -R2.z, c[2];
MUL R1.w, R1, c[6].z;
MAD R1.w, R0, c[4].z, R1;
MAD R2.x, R0.w, c[1], R3.z;
MAD R2.y, R0.w, c[1], R2;
TEX R2, R2, texture[0], 2D;
MUL R2, R2, c[5];
COS R3.y, R1.w;
SIN R3.z, R1.w;
ADD R1.w, fragment.texcoord[0], -c[4].y;
MUL R3.x, R1.w, R3.z;
MUL R3.w, R3.y, R1;
ADD R1.w, fragment.texcoord[0].z, -c[4].x;
MAD R3.x, R1.w, R3.y, -R3;
MAD R3.z, R1.w, R3, R3.w;
ADD R1.w, -R3.z, c[4].y;
ADD R3.x, -R3, c[4];
MAD R3.y, R0.w, c[3], R1.w;
MAD R3.x, R0.w, c[3], R3;
TEX R0.w, R3, texture[1], 2D;
MUL R3.xyz, R2, R0.w;
MAX R0.xyz, R1, R0;
...
rsq_pp r0.z, r0.z
rcp_pp r1.z, r0.z
dp3_pp_sat r3.z, r1, c9
dp3_pp_sat r3.y, r1, c10
dp3_pp_sat r3.x, r1, c11
texld r2, v2, s5
...
mov r2.y, c1.x
add r2.x, -r2, c2
mad r2.x, c0.y, r2.y, r2
mov r2.y, c4.z
mul r1.w, r1, c6.z
mad r1.w, c0.y, r2.y, r1
mad r0.x, r1.w, c7, c7.y
frc r0.x, r0
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
lcbabaaaadaaaaaagfaaaaadpccabaaaaaaaaaaagiaaaaacafaaaaaaefaaaaaj
...

...

...

...
abaaaaaafgiecaiaebaaaaaaaaaaaaaaakaaaaaadiaaaaahjcaabaaaacaaaaaa
...

...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
faaeaaaaeaaaabaabeabaaaafjaaaaaeegiocaaaaaaaaaaaaoaaaaaafjaaaaae
...
void main ()
{
  ...
  lowp vec4 c_8;
  c_8.xyz = ((tmpvar_4.xyz * _LightColor0.xyz) * ((max (0.0, dot (((texture2D (_BumpMap, tmpvar_5).xyz * 2.0) - 1.0), lightDir_2)) * texture2D (_LightTexture0, vec2(tmpvar_7)).w) * 2.0));
  c_8.w = tmpvar_4.w;
  c_1.xyz = c_8.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_9;
  c_9.xyz = ((tmpvar_4.xyz * _LightColor0.xyz) * ((max (0.0, dot (normal_6, lightDir_2)) * texture2D (_LightTexture0, vec2(tmpvar_8)).w) * 2.0));
  c_9.w = tmpvar_4.w;
  c_1.xyz = c_9.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
// FLOW 1 static, 0 dynamic
"vs_4_0
eefiecedbhdihpkapcchdkdjcdpapmmocoefdhnmabaaaaaafeaeaaaaadaaaaaa
...
void main ()
{
  ...
  lowp vec4 c_6;
  c_6.xyz = ((tmpvar_4.xyz * _LightColor0.xyz) * (max (0.0, dot (((texture2D (_BumpMap, tmpvar_5).xyz * 2.0) - 1.0), lightDir_2)) * 2.0));
  c_6.w = tmpvar_4.w;
  c_1.xyz = c_6.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD1;
  lowp vec4 c_7;
  c_7.xyz = ((tmpvar_4.xyz * _LightColor0.xyz) * (max (0.0, dot (normal_6, lightDir_2)) * 2.0));
  c_7.w = tmpvar_4.w;
  c_1.xyz = c_7.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
void main ()
{
  ...
  lowp vec4 c_10;
  c_10.xyz = ((tmpvar_4.xyz * _LightColor0.xyz) * ((max (0.0, dot (((texture2D (_BumpMap, tmpvar_5).xyz * 2.0) - 1.0), lightDir_2)) * atten_9) * 2.0));
  c_10.w = tmpvar_4.w;
  c_1.xyz = c_10.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_11;
  c_11.xyz = ((tmpvar_4.xyz * _LightColor0.xyz) * ((max (0.0, dot (normal_6, lightDir_2)) * atten_10) * 2.0));
  c_11.w = tmpvar_4.w;
  c_1.xyz = c_11.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_7 = dot (xlv_TEXCOORD2, xlv_TEXCOORD2);
  lowp vec4 c_8;
  c_8.xyz = ((tmpvar_4.xyz * _LightColor0.xyz) * ((max (0.0, dot (((texture2D (_BumpMap, tmpvar_5).xyz * 2.0) - 1.0), lightDir_2)) * (texture2D (_LightTextureB0, vec2(tmpvar_7)).w * textureCube (_LightTexture0, xlv_TEXCOORD2).w)) * 2.0));
  c_8.w = tmpvar_4.w;
  c_1.xyz = c_8.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_8 = dot (xlv_TEXCOORD2, xlv_TEXCOORD2);
  lowp vec4 c_9;
  c_9.xyz = ((tmpvar_4.xyz * _LightColor0.xyz) * ((max (0.0, dot (normal_6, lightDir_2)) * (texture2D (_LightTextureB0, vec2(tmpvar_8)).w * textureCube (_LightTexture0, xlv_TEXCOORD2).w)) * 2.0));
  c_9.w = tmpvar_4.w;
  c_1.xyz = c_9.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
ceaeaaaaeaaaabaaajabaaaafjaaaaaeegiocaaaaaaaaaaaaoaaaaaafjaaaaae
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD1;
  lowp vec4 c_6;
  c_6.xyz = ((tmpvar_4.xyz * _LightColor0.xyz) * ((max (0.0, dot (((texture2D (_BumpMap, tmpvar_5).xyz * 2.0) - 1.0), lightDir_2)) * texture2D (_LightTexture0, xlv_TEXCOORD2).w) * 2.0));
  c_6.w = tmpvar_4.w;
  c_1.xyz = c_6.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD1;
  lowp vec4 c_7;
  c_7.xyz = ((tmpvar_4.xyz * _LightColor0.xyz) * ((max (0.0, dot (normal_6, lightDir_2)) * texture2D (_LightTexture0, xlv_TEXCOORD2).w) * 2.0));
  c_7.w = tmpvar_4.w;
  c_1.xyz = c_7.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedpchjmaadnocflfafhgohdchppckmkcigabaaaaaaneaeaaaaadaaaaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
aaaaaaaaagajbaaaabaaaaaaagijcaaaaaaaaaaaalaaaaaadiaaaaaiocaabaaa
...
DP3 R1.y, fragment.texcoord[2], fragment.texcoord[2];
MUL R2.xyz, R0, c[1];
TEX R0.w, fragment.texcoord[2], texture[3], CUBE;
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
TEX R0.yw, R0.zwzw, texture[1], 2D;
MOV R0.x, c[3].z;
...
//   opengl - ALU: 13 to 30
//   d3d9 - ALU: 13 to 30
//   d3d11 - ALU: 11 to 25, TEX: 0 to 0, FLOW: 1 to 1
SubProgram "opengl " {
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
bkabaaaafjaaaaaeegiocaaaaaaaaaaaalaaaaaafjaaaaaeegiocaaaabaaaaaa
...
void main ()
{
  ...
  tmpvar_7 = (tmpvar_5.xyz * texture2D (_Illum, tmpvar_6).w);
  highp vec2 tmpvar_8;
  tmpvar_8.x = ((_RotMT.x - (((xlv_TEXCOORD1.x - _RotMT.x) * cos(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))) - ((xlv_TEXCOORD1.y - _RotMT.y) * sin(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))))) + (_PanMT.x * _Time.y));
  tmpvar_8.y = ((_RotMT.y - (((xlv_TEXCOORD1.x - _RotMT.x) * sin(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))) + ((xlv_TEXCOORD1.y - _RotMT.y) * cos(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))))) + (_PanMT.y * _Time.y));
  lowp vec3 normal_9;
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
void main ()
{
  ...
  tmpvar_11.x = ((_RotMT.x - (((xlv_TEXCOORD1.x - _RotMT.x) * cos(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))) - ((xlv_TEXCOORD1.y - _RotMT.y) * sin(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))))) + (_PanMT.x * _Time.y));
  tmpvar_11.y = ((_RotMT.y - (((xlv_TEXCOORD1.x - _RotMT.x) * sin(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))) + ((xlv_TEXCOORD1.y - _RotMT.y) * cos(((_RotMT.z * _Time.y) + (3.14159 * (1.0 + (_RotMT.w / 180.0)))))))) + (_PanMT.y * _Time.y));
  lowp vec3 normal_12;
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
void main ()
{
  ...
  tmpvar_17.xyz = lm_14;
  mediump vec4 tmpvar_18;
  tmpvar_18 = (-(log2(max (light_3, vec4(0.001, 0.001, 0.001, 0.001)))) + tmpvar_17);
  light_3 = tmpvar_18;
  lowp vec4 c_19;
  mediump vec3 tmpvar_20;
  tmpvar_20 = (tmpvar_5.xyz * tmpvar_18.xyz);
  c_19.xyz = tmpvar_20;
  c_19.w = tmpvar_5.w;
  c_2 = c_19;
  c_2.xyz = (c_2.xyz + tmpvar_7);
...
void main ()
{
  ...
  tmpvar_22 = (tmpvar_5.xyz * tmpvar_20.xyz);
  c_21.xyz = tmpvar_22;
  c_21.w = tmpvar_5.w;
  c_2 = c_21;
  c_2.xyz = (c_2.xyz + tmpvar_7);
...
Program "fp" {
// Fragment combos: 6
//   opengl - ALU: 41 to 71, TEX: 3 to 6
//   d3d9 - ALU: 61 to 90, TEX: 3 to 6
//   d3d11 - ALU: 25 to 49, TEX: 3 to 6, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
Vector 0 [_Time]
Vector 1 [_PanMT]
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
egiocaaaaaaaaaaaahaaaaaadiaaaaahhcaabaaaaaaaaaaapgapbaaaaaaaaaaa
...
hcaabaaaacaaaaaaegacbaiaebaaaaaaacaaaaaaegbcbaaaaeaaaaaadcaaaaaj
...
COS R3.x, R0.w;
SIN R1.w, R0.w;
DP4 R2.x, fragment.texcoord[4], fragment.texcoord[4];
RSQ R0.w, R2.x;
ADD R3.y, fragment.texcoord[0], -c[2];
RCP R2.y, R0.w;
MUL R2.x, R3.y, R1.w;
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...

...

...

...
MOV R2.w, c[0].y;
MUL R0.x, R0, c[6].z;
MAD R0.x, R2.w, c[2].z, R0;
COS R1.w, R0.x;
SIN R3.x, R0.x;
ADD R0.y, fragment.texcoord[1], -c[2];
MUL R0.z, R3.x, R0.y;
MUL R0.y, R1.w, R0;
ADD R0.x, fragment.texcoord[1], -c[2];
...
MUL R1.y, R1.x, R3.x;
ADD R0.w, fragment.texcoord[0].x, -c[2].x;
MAD R1.y, R0.w, R1.w, -R1;
MUL R0.y, R1.w, R1.x;
MAD R0.y, R0.w, R3.x, R0;
ADD R0.x, -R1.y, c[2];
MAD R0.z, R0, c[6].x, c[6].y;
MUL R1.x, R0.z, c[6].z;
ADD R0.y, -R0, c[2];
...
rsq_pp r0.z, r0.z
rcp_pp r3.z, r0.z
dp3_pp_sat r2.z, r3, c9
dp3_pp_sat r2.y, r3, c10
dp3_pp_sat r2.x, r3, c11
mul_pp r1.xyz, r1.w, r1
mul_pp r1.xyz, r1, r2
add r0.w, v0.y, -c2.y
dp3_pp r2.y, r1, c6.w
...
mul r2.x, r0.w, r0.y
add r0.z, v0.x, -c2.x
mad r2.w, r0.z, r0.x, -r2.x
mul_pp r2.xyz, r1, r2.y
mul r0.x, r0.w, r0
mad r0.x, r0.z, r0.y, r0
add r0.y, -r0.x, c2
add r1.y, -r2.w, c2.x
...
SubProgram "d3d11 " {
Keywords { "LIGHTMAP_ON" "DIRLIGHTMAP_ON" "HDR_LIGHT_PREPASS_OFF" }
ConstBuffer "$Globals" 224 // 128 used size, 14 vars
Vector 48 [_PanMT] 4
Vector 64 [_RotMT] 4
Vector 80 [_PanIL] 4
Vector 96 [_RotIL] 4
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...

...

...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
egacbaaaabaaaaaaaoaaaaahdcaabaaaacaaaaaaegbabaaaadaaaaaapgbpbaaa
adaaaaaaefaaaaajpcaabaaaacaaaaaaegaabaaaacaaaaaaeghobaaaacaaaaaa
aagabaaaacaaaaaaaaaaaaahhcaabaaaacaaaaaaegacbaaaacaaaaaaegbcbaaa
...
MOV R1.w, c[2];
MAD R0.w, R1, c[7].x, c[7].z;
DP4 R2.y, fragment.texcoord[4], fragment.texcoord[4];
RSQ R2.y, R2.y;
MAD R1.xyz, R1, c[7].w, -R0;
MOV R1.w, c[0].y;
MUL R0.w, R0, c[7].y;
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...

...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
acaaaaaaeghobaaaaeaaaaaaaagabaaaaeaaaaaadiaaaaahccaabaaaaaaaaaaa
dkaabaaaadaaaaaaabeaaaaaaaaaaaebdiaaaaahocaabaaaaaaaaaaaagajbaaa
adaaaaaafgafbaaaaaaaaaaaaoaaaaahgcaabaaaabaaaaaaagbbbaaaadaaaaaa
...
agaabaaaaaaaaaaaegacbaaaadaaaaaaaaaaaaajgcaabaaaabaaaaaafgbebaaa
...

